...
@interface MMSFetchedPageContainerDataSource()

@end

@implementation MMSFetchedPageContainerDataSource
...
@implementation UIViewController (MMSFetchedPageContainerDataSource)
