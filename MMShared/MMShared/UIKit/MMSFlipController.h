...
@interface MMSFlipController : UITabBarController
...
@interface UIViewController (MMSFlipControllerItem)
...
@property(nullable, nonatomic, readonly, strong) MMSFlipController *flipController; // If the view controller has a tab bar controller as its ancestor, return it. Returns nil otherwise.
