//
//  MMSAnnotationsTableBarButtonItem.h
//  MMShared
//
...
/*
 ...
 - (void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control {
    ...
    if(view.rightCalloutAccessoryView == control){
        ...
        MMSAnnotationsTableBarButtonItem* a = (MMSAnnotationsTableBarButtonItem*)control;
...
@protocol MMSAnnotationsTableBarButtonItemDelegate;

@interface MMSAnnotationsTableBarButtonItem : UIBarButtonItem
