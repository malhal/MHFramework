...
static void * const kMMSMapTypeBarButtonItemContext = (void *)&kMMSMapTypeBarButtonItemContext;

@interface MMSMapTypeBarButtonItem()

@property (nonatomic, assign) BOOL ignoreChange;

@end

@implementation MMSMapTypeBarButtonItem
...
- (id)initWithMapView:(MKMapView *)mapView{
    ...
    if (self) {
        ...
        [mapView addObserver:self forKeyPath:NSStringFromSelector(@selector(mapType))
                     ...
                     context:kMMSMapTypeBarButtonItemContext];
                       ...
                       context:(void *)context
{
    ...
    if(context == kMMSMapTypeBarButtonItemContext){
