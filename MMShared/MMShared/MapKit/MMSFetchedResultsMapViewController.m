//
//  MMSFetchedResultsMapViewController.m
//  MMShared
//
...
#import "MMSFetchedResultsMapViewController.h"
//#import "NSPredicate+MMSMK.h"

//NSString* kDefaultAnnotationViewIdentifier = @"Pin";

@interface MMSFetchedResultsMapViewController()
...
@implementation MMSFetchedResultsMapViewController
...
//    return [NSPredicate mms_predicateWithCoordinateRegion:region];
//}
...
//        UIImage *image = [[UIImage imageNamed:@"DisclosureArrow" inBundle:[NSBundle bundleForClass:MMSFetchedResultsMapViewController.class] compatibleWithTraitCollection:nil] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
