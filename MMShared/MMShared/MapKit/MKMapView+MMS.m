#import "MKMapView+MMS.h"

#define MERCATOR_OFFSET 268435456
#define MERCATOR_RADIUS 85445659.44705395

@implementation MKMapView (MMS)
...
- (MKCoordinateSpan)mms_coordinateSpanWithMapView:(MKMapView *)mapView
                   ...
                   animated:(BOOL)animated
{
    ...
    MKCoordinateSpan span = [self mms_coordinateSpanWithMapView:self centerCoordinate:centerCoordinate andZoomLevel:zoomLevel];
...
-(void)mms_setVisibleMapRectToAnnotations{
    [self mms_setVisibleMapRectToAnnotationsAnimated:NO];
}
