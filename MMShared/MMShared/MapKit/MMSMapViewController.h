...
MMS_EXTERN NSString * const MHShowAnnotationSegueIdentifier; // The default is 'showAnnotation' so set that identifier in the storyboard manual segue.
MMS_EXTERN NSString * const MHAnnotationCellIdentifier; // To use a custom cell in the table view that is hooked up to the outlet use the identifier 'annotation'
