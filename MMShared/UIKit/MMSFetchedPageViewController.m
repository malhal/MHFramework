//
//  MMSFetchedPageViewController.m
//  MMShared
//
...
#import "MMSFetchedPageViewController.h"
#import "MMSFetchedPageContainerDataSource.h"
//#import "MMSFetchedPageViewControllerDelegate.h"

@interface MMSFetchedPageViewController ()
...
@implementation MMSFetchedPageViewController

- (void)setFetchedPageContainerDataSource:(MMSFetchedPageContainerDataSource *)fetchedPageContainerDataSource{
...
- (id)selectedPageObject{
    id<MMSDelegateSelection> delegate = (id<MMSDelegateSelection>)self.delegate;
