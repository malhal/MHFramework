...
@protocol MMSEditableTableCellDelegate;

@interface MMSEditableTableCell : UITableViewCell <UITextFieldDelegate>

@property (nonatomic, assign, nullable) id<MMSEditableTableCellDelegate> delegate;
...
@protocol MMSEditableTableCellDelegate <NSObject>

@optional

- (void)editableTableCell:(MMSEditableTableCell *)editableTableCell textDidChange:(NSString *)text;
