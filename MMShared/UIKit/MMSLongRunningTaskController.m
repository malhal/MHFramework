...
#import "MMSLongRunningTaskController.h"

static void * const kMMSLongRunningTaskControllerKVOContext = (void*)&kMMSLongRunningTaskControllerKVOContext;

@implementation MMSLongRunningTaskController
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context{
    if(context != kMMSLongRunningTaskControllerKVOContext){
...
- (void)startTask:(void (^)(NSProgress *progress))progressBlock completionBlock:(void (^)(BOOL cancelled))completionBlock{
    ...
    [progress addObserver:self forKeyPath:@"fractionCompleted" options:0 context:kMMSLongRunningTaskControllerKVOContext];
