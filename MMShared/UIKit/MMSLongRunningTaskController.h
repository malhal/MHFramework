...
@interface MMSLongRunningTaskController : NSObject <MMSProgressViewControllerDelegate>
...
@property (strong, nonatomic, nullable) MMSProgressViewController *progressViewController;
