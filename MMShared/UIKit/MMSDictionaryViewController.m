...
#import "MMSDictionaryViewController.h"

@interface MMSDictionaryViewController()

@property NSArray* keys;

@end

@implementation MMSDictionaryViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MMSDictionaryViewController* dvc = [MMSDictionaryViewController.alloc initWithStyle:UITableViewStylePlain];
    dvc.dictionary = d;
    dvc.title = key;
